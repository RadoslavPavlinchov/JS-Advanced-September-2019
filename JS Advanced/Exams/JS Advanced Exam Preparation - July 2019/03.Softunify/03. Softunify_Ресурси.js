...
// const SoftUniFy = require('./script');
...
describe('SoftUniFy', () => {
    ...
    describe('allSongs property', () => {
        it('empty object', () => {
            instance = new SoftUniFy();
            const test = instance.allSongs;
    ...
    describe('playSong(song)', () => {
        it('No downloads', () => {
            instance = new SoftUniFy();
            const test = instance.playSong('name');
            assert.equal(test, `You have not downloaded a name song yet. Use SoftUniFy's function downloadSong() to change that!`);
        });
    });
